...
from tdam.plot import MapperLayoutInteractive
from TrafficTDApythonUtils.utils_v3 import rotate_x, rotate_y, rotate_z
...
class MapperPlotter:
    ...
    def extract_data(self, rx=False, ry=False, rz=False):
        ...
        self.filtered_info = self.full_info
        
        return self.filtered_info, self.outlier_info

    def map_colors(self, choose, size=0, threshold=5):
        """
        choose: The column name to use for coloring the points.
        size: The minimum size of the points to consider.
        threshold: The minimum threshold for the points to consider.
        """
    ...
    def plot(self, choose, avg=None, save_path=None, set_label=False, size=100, anchor=1):
        """
        choose: The column name to use for coloring the points.
        avg: Whether to use average values for coloring.
        save_path: The path to save the plot.
        set_label: Whether to set labels for the plot.
        size: The size of the points to plot.
        anchor: The anchor point for the legend.
        """
