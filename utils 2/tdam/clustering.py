...
from tdam.core import mapper_connected_components, TrivialCover
import tdam.core
from tdam._common import (
    ParamsMixin,
    EstimatorMixin,
    clone,
    warn_deprecated,
...
class TrivialClustering(tdam.core.TrivialClustering):
    """
    **DEPRECATED**: This class is deprecated and will be removed in a future
    ...
    def __init__(self):
        warn_deprecated(
            ...
            tdam.core.TrivialClustering.__qualname__,
        )
        super().__init__()


class FailSafeClustering(tdam.core.FailSafeClustering):
    """
    **DEPRECATED**: This class is deprecated and will be removed in a future
    ...
    def __init__(self, clustering=None, verbose=True):
        warn_deprecated(
            ...
            tdam.core.FailSafeClustering.__qualname__,
        )
